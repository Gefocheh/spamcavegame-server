...
// Если пусто, добавляем сервер по умолчанию
if(!servers.includes(DEFAULT_SERVER)) servers.unshift(DEFAULT_SERVER);

// Подставляем в input текущий сервер
